...
*/
export declare enum SimpleCacheControlPolicies {
    /**
...
export declare enum DefaultCSBucketSubdirectories {
...
export declare enum FonciiSubdirectories {
    media = "media",
    userGeneratedMedia = "user-generated-media",
    profilePicture = "profile-picture"
}
export declare enum FonciiMapsSubdirectories {
    media = "media",
    userGeneratedMedia = "user-generated-media",
    posts = "posts",
 ...
 */
export declare enum SupportedFonciiMapsPostContentTypes {
    jpg = "image/jpg",
    jpeg = "image/jpeg",
    png = "image/png",
    mp4 = "video/mp4",
...
export declare enum MediaServerResizingParams {
    height = "h",
    width = "w",
    quality = "q",
    fit = "it",
...
export declare enum MediaServerImageFitParams {
    contain = "cn",
    cover = "co",
    fill = "fl",
    inside = "in",
 ...
 */
export declare enum MediaServerImageFormatParams {
    /** jpg */
    f1 = "f1",
    /** jpeg */
    f2 = "f2",
