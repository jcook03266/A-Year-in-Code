 ...
 * data with.
 */
export declare enum AnalyticsTimespan {
    OneMonth = "ONE_MONTH",
    OneWeek = "ONE_WEEK",
    OneYear = "ONE_YEAR",
...
export declare enum FmIntegrationProviders {
...
export declare enum FonciiBizEvents {
    Placeholder = "PLACEHOLDER"
}
/** Foncii consumer platform events */
export declare enum FonciiEvents {
 ...
 */
export declare enum FonciiUserProfileTasks {
...
export declare enum InfluencerLeaderboardCategory {
    New = "NEW",
    TopRated = "TOP_RATED",
    Trending = "TRENDING"
}
...
export declare enum PostMediaTypes {
...
export declare enum ReservationIntentOutcome {
    Confirmed = "CONFIRMED",
    Failed = "FAILED",
    Passive = "PASSIVE"
}
 ...
 */
export declare enum ReservationProviders {
    Resy = "RESY"
}
 ...
 */
export declare enum RestaurantAutoCompleteSuggestionSources {
    Foncii = "FONCII",
    Google = "GOOGLE"
}
...
export declare enum ShareSheetDestination {
    Clipboard = "CLIPBOARD",
    Facebook = "FACEBOOK",
    Linkedin = "LINKEDIN",
    Reddit = "REDDIT",
 ...
 */
export declare enum SupportedFonciiPlatforms {
    Foncii = "FONCII",
